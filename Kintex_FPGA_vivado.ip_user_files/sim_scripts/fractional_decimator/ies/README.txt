...
#
# Generated by export_simulation on Tue Oct 02 15:23:43 +0300 2018
#
################################################################################
...
'-reset_run' switch to the './fractional_decimator.sh' script.

./fractional_decimator.sh -reset_run
...
./fractional_decimator.sh -noclean_files

For more information on the script, please type './fractional_decimator.sh -help'.
