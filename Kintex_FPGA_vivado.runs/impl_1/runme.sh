...
HD_PWD='D:/GitHub/Kintex_FPGA/Kintex_FPGA_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log u2plus.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source u2plus.tcl -notrace
