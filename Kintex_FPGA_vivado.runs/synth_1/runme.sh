...
HD_PWD='D:/GitHub/Kintex_FPGA/Kintex_FPGA_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u2plus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u2plus.tcl
